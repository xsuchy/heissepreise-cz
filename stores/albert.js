...
async function runLocal() {
    ...
    let albertItems = await exports.fetchData(1);
    fs.writeFileSync(`data/albert-${tdy}.json`, JSON.stringify(albertItems));
    analysis.writeJSON(`data/albert-${tdy}.json`, albertItems, analysis.FILE_COMPRESSOR);
    debugger;
}
